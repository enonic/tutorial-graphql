...
The https://developer.enonic.com/docs/enonic-cli[Enonic CLI] manages sandboxes, projects and deployments.
...
Click btn:[Log In as Guest] to open the XP admin dashboard to see if everything is working.
