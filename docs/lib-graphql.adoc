...
By default the type of a field has an occurrence of 0..1.
...
You cannot alter an interface- or object-type after its definition, but both of them reference each other upon definition, so who do you define first?
