...
NOTE: The starter you created your app from already contains the Webpack and Gradle configuration that bundles these assets, so there is nothing to set up here. To see how it works, open `webpack.config.js` and `build.gradle` in your project.
